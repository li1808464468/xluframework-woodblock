/****************************************************文件：AssetBundles_AssetBundleManagerWrap.cs作者：haitao.li日期：2023/05/21 14:27:17功能：Nothing*****************************************************/#if USE_UNI_LUA
...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetBundlesAssetBundleManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 24, 3, 0);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddAssetbundleAtlasCache", _m_AddAssetbundleAtlasCache);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ClearAssetsCacheExcludeLua", _m_ClearAssetsCacheExcludeLua);
        ...
        static int _m_AddAssetbundleAssetsCache(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Type>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& (LuaAPI.lua_isnil(L, 5) || LuaAPI.lua_type(L, 5) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    bool _isAtlas = LuaAPI.lua_toboolean(L, 4);
                    string _postfix = LuaAPI.lua_tostring(L, 5);
                    
                    gen_to_be_invoked.AddAssetbundleAssetsCache( _assetbundleName, _assetType, _isAtlas, _postfix );
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Type>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    gen_to_be_invoked.AddAssetbundleAssetsCache( _assetbundleName, _assetType, _isAtlas );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddAssetbundleAtlasCache(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    gen_to_be_invoked.AddAssetbundleAtlasCache( _assetbundleName, _postfix );
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    gen_to_be_invoked.AddAssetbundleAtlasCache( _assetbundleName );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleManager.AddAssetbundleAtlasCache!");
        ...
        static int _m_LoadAssetBundleAsync(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Type>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _isatlas = LuaAPI.lua_toboolean(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadAssetBundleAsync( _assetbundleName, _type, _isatlas );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Type>(L, 3)) 
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 3, typeof(System.Type));
                        ...
                        var gen_ret = gen_to_be_invoked.LoadAssetBundleAsync( _assetbundleName, _type );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleManager.LoadAssetBundleAsync!");
		    ...
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.Type>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _isAtlas = LuaAPI.lua_toboolean(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadAssetAsync( _assetPath, _assetType, _isAtlas );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ClearAssetsCacheExcludeLua(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ClearAssetsCacheExcludeLua(  );
