...
namespace XLua.CSObjectWrap
{
    ...
    public class ByteBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(ByteBuffer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					var gen_ret = new ByteBuffer(_data);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ByteBuffer constructor!");
        ...
        static int _m_ToBytes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.ToBytes(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
