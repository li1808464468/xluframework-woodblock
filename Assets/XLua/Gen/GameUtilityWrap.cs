...
namespace XLua.CSObjectWrap
{
    ...
    public class GameUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetInternet", _m_GetInternet_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "NeverSleep", _m_NeverSleep_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "FindChildRecursion", _m_FindChildRecursion_xlua_st_);
        ...
        static int _m_GetPlatform_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = GameUtility.GetPlatform(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_IsMobile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = GameUtility.IsMobile(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetInternet_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = GameUtility.GetInternet(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_NeverSleep_xlua_st_(RealStatePtr L)
        {
		    try {
        ...
        static int _m_GetTimeStamp_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = GameUtility.GetTimeStamp(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_IsPointerOverGameObject_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = GameUtility.IsPointerOverGameObject(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.GameObject _pressObject;
                        ...
                        var gen_ret = GameUtility.GetPointerOverGameObject( out _pressObject );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_FindChildRecursion_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = GameUtility.FindChildRecursion( _parent, _name );
                        translator.Push(L, gen_ret);
