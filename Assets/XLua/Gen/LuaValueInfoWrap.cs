    ...
    public class LuaValueInfoWrap 
    {
        ...
        static int _g_get_valueType(RealStatePtr L)
        {
		    try {
                ...
                LuaValueInfo gen_to_be_invoked = (LuaValueInfo)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.valueType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_valueStr(RealStatePtr L)
        {
		    try {
                ...
                LuaValueInfo gen_to_be_invoked = (LuaValueInfo)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.valueStr);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_valueType(RealStatePtr L)
        {
		    try {
                ...
                LuaValueInfo gen_to_be_invoked = (LuaValueInfo)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.valueType = LuaAPI.lua_tostring(L, 2);
        ...
        static int _s_set_isValue(RealStatePtr L)
        {
		    try {
                ...
                LuaValueInfo gen_to_be_invoked = (LuaValueInfo)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.isValue = LuaAPI.lua_toboolean(L, 2);
