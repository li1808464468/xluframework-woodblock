/****************************************************文件：AssetBundles_AssetBundleUtilityWrap.cs作者：haitao.li日期：2023/05/21 14:27:17功能：Nothing*****************************************************/#if USE_UNI_LUA
...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetBundlesAssetBundleUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "IsEditorMode", _m_IsEditorMode_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetPersistentTempPath", _m_GetPersistentTempPath_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetAssetBundleDataPath", _m_GetAssetBundleDataPath_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsEditorMode_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.IsEditorMode(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetPersistentTempPath_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetPersistentTempPath( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetPersistentTempPath(  );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleUtility.GetPersistentTempPath!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAssetBundleDataPath_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _filePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = AssetBundles.AssetBundleUtility.GetAssetBundleDataPath( _filePath );
                        LuaAPI.lua_pushstring(L, gen_ret);
