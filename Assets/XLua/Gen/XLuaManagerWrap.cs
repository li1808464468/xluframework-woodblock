...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SafeDoStringReturn", _m_SafeDoStringReturn);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SafeDoStringReturn(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _scriptContent = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SafeDoStringReturn( _scriptContent );
                        translator.Push(L, gen_ret);
