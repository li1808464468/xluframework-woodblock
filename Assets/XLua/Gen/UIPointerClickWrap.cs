...
namespace XLua.CSObjectWrap
{
    ...
    public class UIPointerClickWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UIPointerClick);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UIPointerClick();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UIPointerClick constructor!");
        ...
        static int _m_OnPointerClick(RealStatePtr L)
        {
		    try {
                ...
                UIPointerClick gen_to_be_invoked = (UIPointerClick)translator.FastGetCSObj(L, 1);
