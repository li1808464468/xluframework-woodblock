/****************************************************文件：AssetBundles_UnityWebAssetRequesterWrap.cs作者：haitao.li日期：2023/05/21 14:27:17功能：Nothing*****************************************************/#if USE_UNI_LUA
...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetBundlesUnityWebAssetRequesterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(AssetBundles.UnityWebAssetRequester);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new AssetBundles.UnityWebAssetRequester(_sequence);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.UnityWebAssetRequester constructor!");
        ...
        static int _m_Get_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = AssetBundles.UnityWebAssetRequester.Get(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Recycle_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    AssetBundles.UnityWebAssetRequester _creater = (AssetBundles.UnityWebAssetRequester)translator.GetObject(L, 1, typeof(AssetBundles.UnityWebAssetRequester));
                    
                    AssetBundles.UnityWebAssetRequester.Recycle( _creater );
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                AssetBundles.UnityWebAssetRequester gen_to_be_invoked = (AssetBundles.UnityWebAssetRequester)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.UnityWebAssetRequester.Init!");
